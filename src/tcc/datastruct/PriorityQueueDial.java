...
public class PriorityQueueDial  {
    ...
    public PriorityQueueDial(IGrayScaleImage imgInput, int maxPriority) {
    	this(imgInput, maxPriority, 0, false);
    }
    public PriorityQueueDial(IGrayScaleImage imgInput, int maxPriority, boolean isDual) {
    	this(imgInput, maxPriority, 0, isDual);
    }
    public PriorityQueueDial(IGrayScaleImage imgInput, int maxPriority, int policy){
    	this(imgInput, maxPriority, policy, false);
    }
    public PriorityQueueDial(IGrayScaleImage imgInput, int maxPriority, int policy, boolean isDual) {
    	vetorDDL = new NodeDDL[imgInput.getSize()];
    	this.img = imgInput;
